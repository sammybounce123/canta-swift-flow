    ...
    <div className="space-y-6">
      ...
      <Card className="p-6 shadow-card">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
          {bullets.map((b) => (
            <li key={b} className="flex items-start gap-2 p-3 rounded-lg bg-secondary/40 border border-border">
        ...
        {learnMore && (
          <Link to={learnMore.to as never} className="inline-flex items-center gap-1 mt-5 text-sm font-medium text-primary hover:underline">
