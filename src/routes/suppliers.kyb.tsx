...
const SEED: Doc[] = [
  ...
  },
  {
    ...
    status: "Approved",
    uploadedAt: "2026-04-12",
    fileName: "BankConfirmationLetter.pdf",
  },
  {
    key: "export-licence",
...
function SupplierKybPage() {
  ...
  return (
    <div className="space-y-6">
      <ReadinessBar
        status="Demo Preview"
        cue="KYB verification helps improve trust and unlocks more features."
      />
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <Badge variant="outline" className={statusTone(status)}>
                {statusIcon(status)} {overallStatus(docs)}
              </Badge>
              {demo && (
                <Badge className="bg-emerald-100 text-emerald-800 text-[10px]">Demo verified</Badge>
              )}
              {overallStatus(docs) === "Approved" && (
