    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <Card className="lg:col-span-2 p-6 bg-gradient-card text-primary-foreground border-none shadow-elevated overflow-hidden relative">
          ...
          <div className="relative">
            ...
            <div className="mt-2 flex items-end gap-3">
              ...
              <div className="text-success-foreground inline-flex items-center gap-1 bg-success/20 text-success px-2 py-1 rounded text-xs mb-2">
                <ArrowUpRight className="h-3 w-3" /> +4.8% this week
              </div>
            </div>
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
              {wallets.map((w) => (
                <div key={w.ccy} className="rounded-lg bg-white/5 backdrop-blur border border-white/10 px-3 py-2.5">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              ...
              <Button variant="secondary" className="bg-white/10 hover:bg-white/15 text-primary-foreground border border-white/15">
        ...
        <Card className="p-6 shadow-card">
          ...
          <Button variant="outline" className="w-full mt-4">Open Exchange</Button>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <Card className="p-6 shadow-card border-accent/30 bg-gradient-to-br from-accent/5 to-transparent">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Consider converting up to <span className="font-semibold text-foreground">$2.4M</span> in
            export proceeds within the next 24 hours.
          </p>
          ...
          <Button className="w-full mt-5 bg-accent text-accent-foreground hover:bg-accent/90">
            Convert now
          </Button>
        </Card>
      </div>
            ...
            <tbody>
              {transactions.slice(0, 6).map((t) => (
                <tr key={t.id} className="border-t border-border hover:bg-secondary/30">
                  ...
                  <td className="px-5 py-3">
                    <span className="text-xs px-2 py-0.5 rounded bg-secondary text-secondary-foreground">{t.type}</span>
                  </td>
