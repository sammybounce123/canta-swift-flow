  ...
  return (
    <div className="space-y-4">
        ...
        <Card className="p-4 border-emerald-300 bg-emerald-50 text-emerald-900 flex items-start gap-3">
          ...
          <div className="text-sm flex-1">
            ...
            <div className="text-xs mt-1">
              This supplier persona is pre-verified for the investor demo. Payout account status:
              Demo verified.
            </div>
          </div>
        ...
        <Card className="p-4 border-amber-300 bg-amber-50 text-amber-900 flex items-start gap-3">
          ...
          <div className="text-sm flex-1">
            <div className="font-semibold">
              Complete supplier verification to receive RMB settlement.
            </div>
            <div className="text-xs mt-1">
              You can view payment requests, upload invoices/documents, and message buyers or Canta
              before verification. RMB payouts unlock only after verification is approved — review
              timing depends on document completeness and compliance checks.
            </div>
          </div>
          <Badge
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="p-4 space-y-2">
          ...
          <ul className="text-xs space-y-1">
            <li className="flex items-center justify-between">
              Business licence <Badge className="bg-emerald-100 text-emerald-800">Verified</Badge>
            </li>
            <li className="flex items-center justify-between">
              Tax certificate <Badge className="bg-amber-100 text-amber-800">Pending</Badge>
            </li>
            <li className="flex items-center justify-between">
              Export licence <Badge variant="outline">Required</Badge>
            </li>
          </ul>
          <Button size="sm" variant="outline">
        ...
        <Card className="p-4 space-y-2">
          <div className="text-sm font-semibold flex items-center gap-1">
            <UserCheck className="h-4 w-4" /> Authorized Representative
          </div>
          <ul className="text-xs text-muted-foreground space-y-1">
            <li>Name: Li Wei</li>
        ...
        <Card className="p-4 space-y-2">
          <div className="text-sm font-semibold flex items-center gap-1">
            <Landmark className="h-4 w-4" /> Bank / RMB Payout Details
          </div>
          <ul className="text-xs text-muted-foreground space-y-1">
