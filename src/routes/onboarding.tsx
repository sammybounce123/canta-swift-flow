...
import { Building2, Ship, Globe, Factory, Home, ArrowRight, CheckCircle2 } from "lucide-react";
  ...
  head: () => ({
    meta: [
      { title: "Workspace Onboarding — Canta" },
      {
        name: "description",
        content:
          "Choose your Canta workspace — Importer Trade Desk, Supplier Portal, Enterprise Treasury, or Partner Mode.",
      },
    ],
  }),
...
const DO_BULLETS: Partial<Record<WorkspaceType, string[]>> = {
  enterprise_treasury: [
    "FX & multi-currency wallets",
    "Approvals & beneficiaries",
    "Treasury reports & compliance",
  ],
  importer_portal: [
    "Track shipments & landed cost",
    "Manage suppliers & documents",
    "Pay in any currency",
  ],
  supplier_dashboard: [
    "Invoice buyers in any market",
    "Receive payments globally",
    "Get settled in your local currency",
  ],
  partner_property: [
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {SEGMENTS.filter((s) => VISIBLE.includes(s.id))
            .sort((a, b) => VISIBLE.indexOf(a.id) - VISIBLE.indexOf(b.id))
            .map((s) => {
        ...
        <div className="mt-10 text-center text-xs text-muted-foreground">
          Need help choosing?{" "}
          <a href="mailto:onboarding@canta.app" className="text-primary font-medium">
            Talk to onboarding
          </a>
