      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <Badge variant="outline" className="gap-1">
            <ShieldCheck className="h-3 w-3" /> {ws.badge}
          </Badge>
          <h1 className="text-2xl font-semibold tracking-tight mt-2">
            {ws.workspaceLabel} Verification
          </h1>
          <p className="text-sm text-muted-foreground mt-1 max-w-2xl">
            Review required documents, business details, and settlement readiness for this
            workspace.
          </p>
        ...
        <Button onClick={() => toast.success("Verification documents submitted")}>
          Submit for review
        </Button>
      </header>
