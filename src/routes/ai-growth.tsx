...
const CATEGORIES: { l: Category; i: any; tone: string }[] = [ // eslint-disable-line @typescript-eslint/no-explicit-any
...
const seedLeads: Lead[] = [
  {
    id: "LD-401",
    business: "Mega Plaza Imports",
    contact: "Chuka Eze",
    phone: "+234 803 221 0098",
    email: "chuka@megaplaza.ng",
    category: "Importers",
    market: "Lagos · Computer Village",
    corridor: "NG ↔ CN",
    volume: 280_000,
    source: "Inbound Web",
    status: "Hot Lead",
    agent: "Adaeze O.",
    score: 92,
    painPoint: "5-day supplier settlement delays from Shenzhen",
    recommended: "Trade Desk",
    followUp: "2026-06-09",
  },
  {
    id: "LD-402",
    business: "Africa Cargo Express",
    contact: "Bola Adeniyi",
    phone: "+234 802 110 8845",
    email: "ops@africargo.com",
    ...
    agent: "Kunle A.",
    score: 81,
    painPoint: "Manual shipment updates to customers",
    recommended: "Freight Workspace",
    followUp: "2026-06-10",
  },
  {
    id: "LD-403",
    business: "Hangzhou Apparel Group",
    contact: "Wei Liu",
    phone: "+86 138 0011 4422",
    email: "wei@hzapparel.cn",
    category: "Suppliers",
    market: "Hangzhou Industrial",
    corridor: "CN ↔ NG",
    volume: 95_000,
    source: "Outbound",
    status: "Warm Lead",
    agent: "Fatima M.",
    score: 76,
    painPoint: "Unstable NGN→CNY settlement timing",
    recommended: "Supplier Settlement",
    followUp: "2026-06-11",
  },
  {
    id: "LD-404",
    business: "Pan-African University",
    contact: "Dr. Helen Otu",
    phone: "+44 20 7946 0815",
    email: "bursar@pau.edu",
    category: "Global Merchants",
    market: "London HQ",
    corridor: "GB ↔ Africa",
    volume: 410_000,
    source: "Partnership",
    ...
    agent: "Tomiwa L.",
    score: 88,
    painPoint: "Tuition collections from 4 African markets",
    recommended: "Global Collections",
    followUp: "2026-06-09",
  },
  {
    id: "LD-405",
    business: "Royal Dubai Motors",
    contact: "Khalid R.",
    phone: "+971 50 119 8842",
    email: "sales@royaldxbmotors.ae",
    category: "Suppliers",
    market: "Deira Auto Market",
    corridor: "AE ↔ NG",
    volume: 60_000,
    source: "Trade Fair",
    status: "Cold Lead",
    agent: "Fatima M.",
    score: 67,
    painPoint: "Buyers default on auction balances",
    recommended: "Supplier Settlement",
    followUp: "2026-06-15",
  },
  {
    id: "LD-406",
    business: "Balogun Trade Hub",
    contact: "Mama Risi",
    phone: "+234 803 442 7765",
    email: "balogun@traders.ng",
    category: "Importers",
    market: "Lagos · Balogun",
    corridor: "NG ↔ CN",
    volume: 320_000,
    source: "Field Sales",
    status: "Hot Lead",
    agent: "Chinedu E.",
    score: 90,
    painPoint: "Cash-based supplier payments to Yiwu",
    recommended: "Trade Desk",
    followUp: "2026-06-08",
  },
  {
    id: "LD-407",
    business: "Spark Media Africa",
    contact: "Tomi Bello",
    phone: "+234 805 220 9988",
    email: "tomi@sparkmedia.africa",
    category: "Treasury Prospects",
    market: "Lagos · VI",
    corridor: "NG ↔ Global",
    volume: 48_000,
    source: "Inbound Web",
    ...
    agent: "Adaeze O.",
    score: 73,
    painPoint: "Needs cleaner approvals for recurring international payments",
    recommended: "Enterprise Treasury",
    followUp: "2026-06-12",
  },
  {
    id: "LD-408",
    business: "Coastal Estates",
    contact: "Bayo Coker",
    phone: "+234 802 770 4421",
    email: "info@coastal.ng",
    category: "Global Merchants",
    market: "Lagos · Lekki",
    corridor: "NG ↔ Diaspora",
    volume: 220_000,
    source: "Inbound Web",
    status: "Warm Lead",
    agent: "Tomiwa L.",
    score: 79,
    painPoint: "Diaspora rent collection in FX",
    recommended: "Global Collections",
    followUp: "2026-06-13",
  },
  {
    id: "LD-409",
    business: "Federal Polytechnic Co-op",
    contact: "Mr. Adekunle",
    phone: "+234 803 119 6500",
    email: "coop@fedpoly.ng",
    ...
    agent: "Chinedu E.",
    score: 41,
    painPoint: "Procurement cycle just closed",
    recommended: "Enterprise Treasury",
    followUp: "2026-07-02",
  },
];
  ...
  return (
    <Card className="p-4 shadow-card">
      <div className="flex items-start justify-between">
        ...
        <div
          className={`h-7 w-7 rounded-lg grid place-items-center ${tone ?? "bg-primary/10 text-primary"}`}
        >
          ...
          <tbody>
            {filtered.map((l) => (
              <tr key={l.id} className="border-t border-border hover:bg-secondary/30">
                ...
                <td className="px-4 py-3">
                  <span className={`font-semibold tabular-nums ${scoreColor(l.score)}`}>
                    {l.score}
                  </span>
                </td>
                <td className="px-4 py-3">
                  <Badge variant="outline" className={`text-[10px] ${stageTone(l.status)}`}>
                    {l.status}
                  </Badge>
                </td>
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
      <Card className="p-5 shadow-card lg:col-span-2">
        <div className="text-sm font-semibold flex items-center gap-2">
          <Flame className="h-4 w-4 text-destructive" /> Score breakdown — Mega Plaza Imports
        </div>
          ...
          {factors.map((f) => (
            <div key={f.l}>
              <div className="flex items-center justify-between text-xs mb-1">
                <span>{f.l}</span>
                <span className={`tabular-nums font-semibold ${scoreColor(f.v)}`}>{f.v}</span>
              </div>
      ...
      <Card className="p-5 shadow-card bg-gradient-to-br from-destructive/5 to-transparent">
        ...
        <Badge variant="outline" className={`mt-2 ${stageTone("Hot Lead")}`}>
          Hot Lead
        </Badge>
        <div className="mt-4 space-y-2 text-xs">
          {(["Hot Lead", "Warm Lead", "Cold Lead", "Not Ready"] as Stage[]).map((s) => (
            <div key={s} className="flex items-center justify-between">
              <Badge variant="outline" className={`text-[10px] ${stageTone(s)}`}>
                {s}
              </Badge>
  ...
  return (
    <Card className="p-5 shadow-card border-accent/30 bg-gradient-to-br from-accent/5 to-transparent">
      <div className="flex items-start justify-between">
        <div>
          <div className="text-sm font-semibold flex items-center gap-2">
            <Sparkles className="h-4 w-4 text-accent" /> AI Sales Copilot
          </div>
          <div className="mt-2 text-base font-semibold">{lead.business}</div>
          <div className="text-xs text-muted-foreground">
            {lead.category} · {lead.status} · Score {lead.score}
          </div>
        </div>
        <Badge variant="outline" className="text-[10px]">
          {lead.recommended}
      ...
      <div className="mt-4 space-y-3 text-xs">
        <div className="p-3 rounded-lg border border-border bg-card">
          ...
          <p className="text-muted-foreground">
            {lead.business} is a {lead.category.toLowerCase().replace(/s$/, "")} operating on the{" "}
            {lead.corridor} corridor with an estimated {fmtMoney(lead.volume, "USD")} annual volume.
          </p>
        </div>
        <div className="p-3 rounded-lg border border-border bg-card">
        ...
        <div className="p-3 rounded-lg border border-border bg-card">
          ...
          <p className="text-muted-foreground">
            Position <span className="text-foreground font-medium">{lead.recommended}</span> as the
            fastest, safest way to solve this — lead with a 7-day pilot and reference a similar
            customer.
          </p>
        </div>
        <div className="p-3 rounded-lg border border-border bg-card">
          ...
          <p className="text-muted-foreground">
            "We already use a bank" → Show 60–90 second corridor settlement vs 3–5 day SWIFT delay.
            "Pricing concern" → Free during pilot, fee tier kicks in only after first successful
            shipment.
          </p>
        </div>
        <div className="p-3 rounded-lg border border-border bg-card">
          ...
          <p className="text-muted-foreground">
            Send WhatsApp follow-up with landed-cost demo link and book a 20-min call this week.
          </p>
        </div>
        <div className="p-3 rounded-lg border border-border bg-card">
          <div className="font-semibold mb-1">Suggested WhatsApp follow-up</div>
          <p className="text-muted-foreground italic">
            "Hi {lead.contact.split(" ")[0]}, this is {lead.agent} from Canta 👋. Based on your{" "}
            {lead.corridor} shipments, I think {lead.recommended} can save you ~3 days per
            settlement. Quick 20-min call this week?"
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-2 mt-4">
        <Button
          onClick={() => toast.success("WhatsApp follow-up sent")}
...
function WhatsAppOnboarding() {
  const msgs = [
    ...
    {
      from: "canta",
      t: "Supplier: Hangzhou Apparel Group · USD 18,420 · 240 cartons.\nIs this your shipment?",
      time: "09:13",
    },
    ...
    {
      from: "canta",
      t: "Trade File TR-2042 created. Tracking container live + clearing checklist sent.",
      time: "09:15",
    },
  ];
  ...
  return (
    <Card className="shadow-card overflow-hidden">
      <div className="p-4 border-b border-border flex items-center gap-2">
        ...
        <Badge
          variant="outline"
          className="text-[10px] ml-auto bg-success/15 text-success border-success/30"
        >
          Demo
        </Badge>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="p-4 bg-secondary/20 border-r border-border space-y-2 min-h-[420px]">
          {msgs.map((m, i) => (
            <div
              key={i}
              className={`flex ${m.from === "importer" ? "justify-start" : "justify-end"}`}
            >
              <div
                className={`max-w-[80%] rounded-2xl px-3 py-2 text-xs whitespace-pre-line shadow-sm ${
                  m.from === "importer"
          ...
          <Card className="p-4">
            ...
            <div className="grid grid-cols-2 gap-x-3 gap-y-2 text-xs mt-3">
              <div>
                ...
                <div className="font-medium">Hangzhou Apparel Group</div>
              </div>
              <div>
                <div className="text-muted-foreground">Invoice amount</div>
                <div className="font-medium">USD 18,420</div>
              </div>
              <div>
                <div className="text-muted-foreground">Goods</div>
                <div className="font-medium">Fashion · 240 cartons</div>
              </div>
              <div>
                <div className="text-muted-foreground">Container</div>
                <div className="font-medium">MSCU9876543</div>
              </div>
              <div>
                <div className="text-muted-foreground">BL number</div>
                <div className="font-medium">BL-FE-7711</div>
              </div>
              <div>
                <div className="text-muted-foreground">ETA</div>
                <div className="font-medium">2026-06-24 · Apapa</div>
              </div>
              <div>
                <div className="text-muted-foreground">Payment ref</div>
                <div className="font-medium">PAY-CN-0998</div>
              </div>
              <div>
                <div className="text-muted-foreground">Status</div>
                <div className="font-medium">On vessel</div>
              </div>
            </div>
            <Button
              size="sm"
              className="w-full mt-4"
              onClick={() => toast.success("Trade File TR-2042 promoted")}
            >
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
      <Card className="p-5 shadow-card">
        ...
        <div
          className="mt-4 border-2 border-dashed border-border rounded-xl p-6 text-center hover:border-accent transition cursor-pointer"
          onClick={() => {
            setExtracted(true);
        ...
        >
          ...
          <div className="text-sm font-medium mt-2">
            Drop invoice, BL, packing list, freight invoice
          </div>
          <div className="text-xs text-muted-foreground mt-1">PDF, JPG, PNG · up to 25 MB</div>
        </div>
        <div className="mt-4 space-y-1.5 text-xs">
          {["Invoice", "Bill of Lading", "Packing List", "Payment Receipt", "Freight Invoice"].map(
            (t) => (
              <div
                key={t}
                className="flex items-center justify-between border-t border-border pt-1.5 first:border-0 first:pt-0"
              >
      ...
      <Card className="lg:col-span-2 p-5 shadow-card">
        <div className="text-sm font-semibold flex items-center gap-2">
          <Wand2 className="h-4 w-4 text-accent" /> Extracted fields
        </div>
        {!extracted ? (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
      <Card className="p-5 shadow-card">
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          ...
          <div>
            <Label>Clearing (NGN)</Label>
            <Input type="number" value={clearing} onChange={(e) => setClearing(+e.target.value)} />
          </div>
          <div>
            <Label>Port charges (NGN)</Label>
            <Input type="number" value={port} onChange={(e) => setPort(+e.target.value)} />
          </div>
          <div>
            <Label>Local delivery (NGN)</Label>
            <Input type="number" value={delivery} onChange={(e) => setDelivery(+e.target.value)} />
          </div>
          <div>
            <Label>Expected selling (NGN)</Label>
      ...
      <Card className="p-5 shadow-card bg-gradient-to-br from-primary/5 to-transparent">
        <div className="text-sm font-semibold flex items-center gap-2">
          <Wand2 className="h-4 w-4 text-primary" /> AI estimate
        </div>
        ...
        <div className="mt-4 pt-3 border-t-2 border-border space-y-2">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span
              className={`font-bold tabular-nums ${profit >= 0 ? "text-success" : "text-destructive"}`}
            >
              {fmtMoney(profit, "NGN")}
            </span>
          </div>
          <div className="flex items-center justify-between text-sm">
            ...
            <span
              className={`font-bold tabular-nums ${margin >= 20 ? "text-success" : margin >= 10 ? "text-warning" : "text-destructive"}`}
            >
              {margin.toFixed(1)}%
            </span>
          </div>
...
function SupplierMatching() {
  const insights = [
    {
      ...
      cat: "Electronics",
      origin: "Guangzhou, CN",
      action: "Onboard 3 Guangzhou electronics suppliers",
    },
    {
      n: 18,
      cat: "Auto parts",
      origin: "Dubai, AE",
      action: "Sign Deira auto-parts supplier cluster",
    },
    {
      n: 25,
      cat: "Fashion goods",
      origin: "Yiwu, CN",
      action: "Bulk supplier partnership for Yiwu fashion",
    },
    {
      n: 14,
      cat: "Industrial machinery",
      origin: "Istanbul, TR",
      action: "Acquire Turkey machinery supplier rep",
    },
    {
      n: 11,
      cat: "Pharma & medical",
      origin: "Mumbai, IN",
      action: "Compliance-vetted India pharma supplier",
    },
    {
      n: 9,
      cat: "Building materials",
      origin: "Tema, GH",
      action: "Regional supplier for West Africa demand",
    },
  ];
  ...
  return (
    <div className="space-y-4">
      <Card className="p-5 shadow-card">
        <div className="text-sm font-semibold flex items-center gap-2">
          <Brain className="h-4 w-4 text-accent" /> Repeated supplier demand across importers
        </div>
        <div className="text-xs text-muted-foreground mt-1">
          Categories where multiple importers buy from the same origin — supplier acquisition
          targets.
        </div>
          ...
          {insights.map((i) => (
            <Card key={i.cat} className="p-4 shadow-card">
              ...
              <Button
                ...
                onClick={() => toast.success("Supplier outreach queued")}
              >
                Queue outreach
              </Button>
            </Card>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-end justify-between flex-wrap gap-4">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => toast.success("Lead list exported")}>
            Export leads
          </Button>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
        ...
        <KPI
          ...
          value={`$${(kpis.pipeline / 1_000_000).toFixed(2)}M`}
          sub="Estimated"
          icon={TrendingUp}
        />
        ...
        {CATEGORIES.map((c) => {
          ...
          return (
            <Card key={c.l} className="p-4 shadow-card">
              <div className={`h-8 w-8 rounded-lg grid place-items-center ${c.tone}`}>
        ...
        <TabsContent value="finder">
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
            <div className="xl:col-span-2">
              <LeadFinder onPick={setActiveLead} />
            </div>
                ...
                {allLeads.map((l) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`text-xs font-semibold tabular-nums ${scoreColor(l.score)}`}>
                        {l.score}
                      </span>
                    </div>
                    <div className="text-[11px] text-muted-foreground">
                      {l.category} · {l.corridor}
                    </div>
                  </button>
                ))}
              </div>
