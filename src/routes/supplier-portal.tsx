  ...
  head: () => ({
    meta: [
      { title: "Supplier Portal — Canta" },
      {
        name: "description",
        content:
          "Create RMB invoices, receive NGN payments from Nigerian buyers and get settled in RMB.",
      },
    ],
  }),
  ...
  return (
    <div className="space-y-5">
      <header className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="min-w-0">
          <Badge variant="outline" className="gap-1">
            <Factory className="h-3 w-3" /> Supplier Portal · 供应商门户
          </Badge>
        ...
        <div
          className="inline-flex h-9 shrink-0 items-center rounded-lg border bg-card p-0.5"
          role="group"
          aria-label="Language"
        >
          <Button
      ...
      <Card className="p-4 text-xs text-muted-foreground">
        Receive-only account. You can only receive buyer payments and settle to your own verified
        RMB/USD bank account.
