      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {role === "marketer"
              ? "Your referred clients and their payment progress."
      ...
      <Card className="p-4 shadow-card">
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <div className="text-xs text-muted-foreground ml-auto">
            {rows.length} of {data.length} cases
          </div>
        </div>
      </Card>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
                  ...
                  <tr key={c.id} className="border-t hover:bg-secondary/30">
                    ...
                    <td className="py-3 px-3 text-right whitespace-nowrap">
                      {flagged.has(c.id) && (
                        <Badge
                          variant="outline"
                          className="text-[10px] bg-amber-500/15 text-amber-700 border-amber-500/30 mr-1"
                        >
                      ...
                      <Button
                        ...
                        onClick={() => setFlagFor({ id: c.id, clientName: c.clientName })}
                      >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            toast.success("Case reassigned", {
                              description: `${c.clientName} · activity log updated.`,
                            })
                          }
                        >
              ...
              {rows.length === 0 && (
                <tr>
                  <td
                    colSpan={showMarketerFilter ? 9 : 8}
  ...
  return (
    <Dialog open onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>
            Flag case for review — {clientName}{" "}
            <span className="text-xs text-muted-foreground font-normal">({caseId})</span>
          </DialogTitle>
        </DialogHeader>
        <div className="space-y-3">
          <div>
            ...
            <Input
              ...
              placeholder="Short reason for flagging..."
            />
          </div>
          <div>
