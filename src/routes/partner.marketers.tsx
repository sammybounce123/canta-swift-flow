    ...
    <div className="space-y-5">
      <div>
        <h1 className="text-2xl font-semibold flex items-center gap-2">
          <Users className="h-5 w-5" /> Marketer performance
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          {role === "partner_manager"
            ? "Your assigned marketers and their pipelines."
            : "Every marketer at Kingsbridge Property Partners — referrals, payouts and conversion."}
        </p>
      </div>
            ...
            <Card key={r.marketer.id} className="p-5 shadow-card">
              ...
              <dl className="grid grid-cols-2 gap-x-4 gap-y-2 mt-5 text-sm">
                ...
                <Cell
                  ...
                  value={r.failedPayouts.toString()}
                  tone={r.failedPayouts ? "text-destructive" : ""}
                />
