...
export const SUPPLIERS: Supplier[] = [
  ...
  {
    id: "SUP-1002",
    company: "Istanbul Textile Group",
    country: "Turkey",
    city: "Istanbul",
  ...
  {
    id: "SUP-1004",
    company: "Mumbai PharmaChem Ltd",
    country: "India",
    city: "Mumbai",
    categories: ["Pharma", "Chemicals"],
    status: "Trade Verified",
    badges: [
      "Business Verified",
      "Factory Address Verified",
  ...
  {
    id: "SUP-1005",
    company: "Guangzhou Machinery Works",
    country: "China",
    city: "Guangzhou",
...
export const BUYERS: Buyer[] = [
  {
    id: "BUY-2001",
    name: "Lagos Global Imports Ltd",
    country: "Nigeria",
    city: "Lagos",
    interests: ["Electronics", "Auto Parts"],
    status: "Premium Verified",
    badges: [
      "KYB Verified",
      "Payment Reliable",
    ...
    paymentScore: 96,
    completedTx: 138,
    avgOrderUsd: [15000, 60000],
    corridors: ["China→Nigeria", "UAE→Nigeria"],
    escrowHistory: 41,
    disputes: 1,
    discoverable: true,
  ...
  {
    id: "BUY-2002",
    name: "Accra MedSupply Co.",
    country: "Ghana",
    city: "Accra",
    interests: ["Pharma", "Medical Devices"],
    status: "Trade Verified",
    badges: ["KYB Verified", "Payment Reliable", "Trade Active", "Escrow Ready"],
    tradeHistory: 58,
    paymentScore: 91,
    completedTx: 54,
    avgOrderUsd: [8000, 30000],
    corridors: ["India→Ghana", "Turkey→Ghana"],
    escrowHistory: 19,
    disputes: 0,
    discoverable: true,
    lastActive: "2 days ago",
  ...
  {
    id: "BUY-2003",
    name: "Nairobi Textiles East Africa",
    country: "Kenya",
    city: "Nairobi",
    interests: ["Textiles", "Apparel"],
    status: "Business Verified",
    badges: ["KYB Verified", "Trade Active"],
    tradeHistory: 27,
    paymentScore: 83,
    completedTx: 24,
    avgOrderUsd: [5000, 18000],
    corridors: ["Turkey→Kenya", "China→Kenya"],
    escrowHistory: 7,
    disputes: 2,
    discoverable: true,
    lastActive: "2 days ago",
  ...
  {
    id: "BUY-2004",
    name: "Abidjan Industrial Group",
    country: "Côte d'Ivoire",
    city: "Abidjan",
    interests: ["Machinery", "Construction"],
    status: "Trade Verified",
    badges: ["KYB Verified", "Payment Reliable", "High-Volume Buyer"],
    tradeHistory: 89,
    paymentScore: 94,
    completedTx: 81,
    avgOrderUsd: [25000, 90000],
    corridors: ["China→CIV", "UAE→CIV"],
    escrowHistory: 28,
    disputes: 1,
    discoverable: true,
    lastActive: "2 days ago",
  ...
  {
    id: "BUY-2005",
    name: "Cairo TradeHub LLC",
    country: "Egypt",
    city: "Cairo",
    interests: ["Chemicals", "Pharma"],
    status: "Basic Verified",
    badges: ["KYB Verified"],
    tradeHistory: 11,
    paymentScore: 74,
    completedTx: 9,
    avgOrderUsd: [3000, 12000],
    corridors: ["India→Egypt", "Turkey→Egypt"],
    escrowHistory: 2,
    disputes: 0,
    discoverable: true,
    lastActive: "2 days ago",
