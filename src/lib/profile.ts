  ...
  switch (workspace) {
    ...
    case "supplier_dashboard":
      return [
        ...
        { to: "/supplier-portal/requests", label: "Payment Requests", iconKey: "receipt", group: "Supplier Portal" },
        { to: "/supplier-portal/fx-quotes", label: "FX Quotes", iconKey: "receipt", group: "Supplier Portal" },
        { to: "/supplier-portal/ngn-details", label: "NGN Payment Details", iconKey: "receipt", group: "Supplier Portal" },
        { to: "/supplier-portal/payout-accounts", label: "Payout Accounts", iconKey: "globe", group: "Supplier Portal" },
        { to: "/supplier-portal/invoices", label: "Invoices", iconKey: "receipt", group: "Supplier Portal" },
        { to: "/supplier-portal/settlement", label: "RMB / USD Settlement", iconKey: "globe", group: "Supplier Portal" },
        { to: "/supplier-portal/trade-files", label: "Trade Files", iconKey: "trade", group: "Operations" },
        { to: "/supplier-portal/documents", label: "Documents", iconKey: "file", group: "Operations" },
        { to: "/supplier-portal/messages", label: "Messages", iconKey: "whatsapp", group: "Operations" },
