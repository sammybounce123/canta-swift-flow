  ...
  switch (workspace) {
    ...
    case "partner_property": {
      ...
      const items: SidebarItem[] = [
        ...
        {
          to: "/partner/payment-cases",
          label: "Solicitor Payment Cases",
          iconKey: "file",
          group: "Referrals",
        },
        {
          to: "/partner/new-payment-case",
          label: "New Client Payment Case",
          iconKey: "sparkles",
          group: "Referrals",
        },
        {
        ...
        {
          to: "/partner/fee-payments",
          label: "Partner Fee Payments",
          iconKey: "receipt",
          group: "Money",
        },
