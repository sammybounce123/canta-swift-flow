...
const SEED: SupportTicket[] = [
  {
    ...
    organization: "Bakare Imports",
    workspace: "Importer",
    linkedRef: "SP-2026-0139",
    priority: "Normal",
    status: "Open",
    ...
    messages: [
      {
        ...
        author: "Tunde",
        role: "customer",
        body: "Please help confirm the latest shipment update and linked documents.",
  ...
  },
  {
    id: "T-001",
    ref: "SUP-9001",
    customer: "Adekunle Okoye",
    organization: "Kingsbridge Property Partners client",
    workspace: "Partner Property",
    linkedRef: "BC-2026-1001",
    priority: "High",
    status: "Waiting on Canta",
    assigned: "Daniel Whitfield",
    ...
    messages: [
      {
        ...
        author: "Adekunle",
        role: "customer",
        body: "Solicitor hasn't received the payment yet.",
  ...
  },
  {
    ...
    organization: "Lagos Med Clinic",
    workspace: "Global Merchant",
    linkedRef: "INV-2034",
    priority: "Normal",
    status: "Open",
    assigned: "Canta Ops",
    ...
    messages: [
      {
        ...
        author: "Tope",
        role: "customer",
        body: "Payer sent ₦4,100,000 instead of ₦4,200,000.",
        at: "2026-06-04T14:00:00Z",
      },
    ],
  ...
  },
  {
    ...
    organization: "Enterprise Treasury",
    workspace: "Enterprise Treasury",
    linkedRef: "PAY-7782",
    priority: "High",
    status: "Open",
    assigned: "Canta Support",
    ...
    messages: [
      {
        ...
        author: "Adaeze",
        role: "customer",
        body: "A beneficiary payout needs a status check.",
        at: "2026-06-12T08:30:00Z",
      },
    ],
...
export function createTicket(
  input: Omit<SupportTicket, "id" | "ref" | "messages" | "createdAt" | "lastUpdate" | "status"> & {
    firstMessage?: string;
  },
): SupportTicket {
...
export function updateTicketStatus(id: string, status: TicketStatus) {
  write(
    read().map((t) =>
      t.id === id ? { ...t, status, lastUpdate: new Date().toISOString().slice(0, 10) } : t,
    ),
  );
}
export function assignTicket(id: string, assigned: string) {
  write(
    read().map((t) =>
      t.id === id ? { ...t, assigned, lastUpdate: new Date().toISOString().slice(0, 10) } : t,
    ),
  );
}
    ...
    read().map((t) =>
      t.id === id
        ? {
            ...
            messages: [
              ...t.messages,
              { ...msg, id: `m${t.messages.length + 1}`, at: new Date().toISOString() },
            ],
            lastUpdate: new Date().toISOString().slice(0, 10),
          }
        : t,
